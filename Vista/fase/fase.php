...
<table class="table table-striped">
    <thead>
        <tr>
            <th style="width:180px;">Còdigo de la fase</th>
            <th style="width:120px;">Nombre de la fase</th>
        </tr>
    </thead>
    <tbody>
    <?php foreach($this->model->listarFase() as $r): ?>
        <tr>
            <td><?php echo $r->idfase; ?></td>
            <td><?php echo $r->descripcion; ?></td>
            <td>
                <a href="?c=fase&a=Crudfase&idfase=<?php echo $r->idfase; ?>">Editar</a>
            </td>
            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=fase&a=Eliminarfase&idfase=<?php echo $r->idfase; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
