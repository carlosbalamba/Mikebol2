...
<table class="table table-striped">
    <thead>
        <tr>
            <th style="width:180px;">Código de la novedad</th>
            <th style="width:120px;">Nombre de la novedad</th>
        </tr>
    </thead>
    <tbody>
    <?php foreach($this->model->listarNovedad() as $r): ?>
        <tr>
            <td><?php echo $r->idnovedad; ?></td>
            <td><?php echo $r->descripcion; ?></td>
            <td>
                <a href="?c=novedad&a=CrudNovedad&idnovedad=<?php echo $r->idnovedad; ?>">Editar</a>
            </td>
            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=novedad&a=EliminarNovedad&idnovedad=<?php echo $r->idnovedad; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
