...
<table class="table">
    <thead>
        <tr>
            <th style="width:180px;">Código del equipo</th>
            <th style="width:120px;">Nombre del equipo</th>
        </tr>
    </thead>
    <tbody>
    <?php foreach($this->model->listarEquipo() as $r): ?>
        <tr>
            <td><?php echo $r->idequipo; ?></td>
            <td><?php echo $r->nombre_equipo; ?></td>
            <td>
                <a href="?c=equipo&a=crudEquipo&idequipo=<?php echo $r->idequipo; ?>">Editar</a>
            </td>
            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=equipo&a=eliminarEquipo&idequipo=<?php echo $r->idequipo; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
